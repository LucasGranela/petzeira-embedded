...
const char PAGE_MAIN_FOR_WIFI_CONNECTION[] PROGMEM = R"=====(
...
<title>Web Page Update Demo</title>
  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <header>
      <div class="navbar fixed-top">
          <div class="container">
            <div class="navtitle">Petzeira ESP Config</div>
    ...
    <main class="container" style="margin-top:70px">
      ...
      <div class="bodytext">
        <form name="wifi_form">
        <label for="wifi_ssid">wifi name:</label>
        <input type="text" id="wifi_ssid" name="wifi_ssid"><br><br>
        <label for="wifi_password">Password:</label>
        <input type="password" id="wifi_password" name="wifi_password"><br><br>
        <input type="submit" value="Submit" onclick="update_wifi_configuration(wifi_form.wifi_ssid.value, wifi_form.wifi_password.value)"/><br><br>
        </form>
      </div>
      <br>
      <br>
  ...
  <script type = "text/javascript">
    ...
    function update_wifi_configuration(name, password) {
      var xhttp = new XMLHttpRequest();

      xhttp.open("PUT", "SEND_WIFI_NAME_PASSWORD?VALUE="+name+","+password, true);
      xhttp.send();
    }
...
const char PAGE_FOR_LOGIN[]  PROGMEM = R"=====(
...
<title>Web Page Update Demo</title>
  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <header>
      <div class="navbar fixed-top">
          <div class="container">
            <div class="navtitle">Petzeira LOGIN Config</div>
            <div class="navdata" id = "date">mm/dd/yyyy</div>
            <div class="navheading">DATE</div><br>
            <div class="navdata" id = "time">00:00:00</div>
            <div class="navheading">TIME</div>
    ...
    <main class="container" style="margin-top:70px">
      ...
      <div class="bodytext">
        ...
        <input type="submit" value="Submit" onclick="update_user_name(username_form.Username.value, username_form.password.value)"/><br><br>
        </form>
      </div>
      <br>
      <br>
  ...
  <script type = "text/javascript">
    ...
    function update_user_name(name, password) {
      var xhttp = new XMLHttpRequest();
      ...
      xhttp.open("PUT", "SEND_NAME_PASSWORD?VALUE="+name+","+password, true);
      xhttp.send();
    }
